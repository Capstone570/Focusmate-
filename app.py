...
<body class="relative flex flex-col justify-between items-center min-h-screen p-6">
    ...
    <canvas id="stage" class="fixed inset-0 w-full h-full"></canvas>

    <!-- SCREEN 1: WELCOME SCREEN -->
    <div id="welcome-screen" class="relative z-10 flex flex-col items-center justify-between min-h-screen text-center w-full max-w-2xl mx-auto py-12">
        <div>
            <h1 class="text-6xl font-extrabold tracking-tight glow-title mb-2">FocusMate AI</h1>
            <p class="text-slate-400 text-lg">Your End-to-End Deep Work Engine</p>
        </div>

        <!-- Speech Bubble positioned with relative offset to prevent robot collisions -->
        <div id="speech-bubble" class="opacity-0 translate-y-4 bg-gradient-to-r from-purple-200 to-pink-200 text-slate-900 font-bold text-xl px-8 py-4 rounded-2xl shadow-lg my-auto">
...
components.html(app_code, height=900, scrolling=False)
